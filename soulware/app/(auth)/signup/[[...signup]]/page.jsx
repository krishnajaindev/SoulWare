        ...
        <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-12 xl:px-16">
          ...
          >
            ...
            <p className="text-xl text-gray-700 dark:text-gray-200 mb-8 leading-relaxed">
              ...
              guidance for their mental health needs.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Users, text: "Connect with Peer Supporters", color: colors.secondary },
                { icon: Sparkles, text: "Access Professional Counseling", color: colors.tertiary },
                { icon: Star, text: "Personalized Mental Health Resources", color: colors.accent }
              ].map((feature, index) => (
                <motion.div
                  key={index}
